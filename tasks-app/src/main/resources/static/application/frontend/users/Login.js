var Login = (props) => {
    ...
    const handleSSO = () => {
        window.location.replace("http://localhost:7777/oauth-server/oauth/authorize?response_type=token&client_id=tasks_app&redirect_uri=http://localhost:8888/tasks-service/dashboard/loginOAuth")
    };
    return (
